 ...
 */
/datum/tgui/New(mob/user, datum/src_object, ui_key, interface, title, ui_x, ui_y, datum/tgui/master_ui, datum/ui_state/state)
	log_tgui(user,
		"new [interface] fancy [user?.client?.prefs.toggles2 & PREFTOGGLE_2_FANCYUI]",
